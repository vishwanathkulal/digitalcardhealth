...
User ➝ Flask Form ➝ PostgreSQL ➝ QR Generation ➝ QR Code Output ↓ QR Scan ↓ /display/<card_id> ➝ Fetch & Render Details

🧪 How It Works
User fills out a form with health details.
Unique card ID is generated, QR code is created.
Data is saved in PostgreSQL with the associated card_id.
QR code displays a URL like /display/<card_id>.
Scanning the QR shows the health details securely.
✅ Results
